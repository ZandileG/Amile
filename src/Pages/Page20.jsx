...
function Page20(){
  ...
  [
    ...
    { text: "“No, we won’t we just have to keep it a secret and make sure Thingo survives,” said Amile.", start: 7, end: 10 },
      ...
      paragraphs: [
  [
    { text: "“Ngifuna ukusiqamba igama elithi Thingo,", start: 0, end: 3.1 },
    { text: "ngoba sinemibala emihle,” kusho uAmile.", start: 3.2, end: 5.4 },
  ],
  [
    { text: "“Yebo, igama elihle kakhulu lelo,” kuphendula uKhaya. “Kodwa awucabangi ukuthi singangena enkingeni ngalokhu?”", start: 5.5, end: 14.8 },
  ],
  [
    { text: "“Ngeke singene enkingeni uma singayigcina njengemfihlo futhi siqinisekise ukuthi uThingo uyaphila,” kusho uAmile.", start: 14.9, end: 23.93 },
  ],
]
    }
};
