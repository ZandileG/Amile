...
function Page11(){
  ...
  return(
    <section className="page-odd">
      <img src={Image11} alt="Page 11" className={Zulu ? "page-image-big-desktop" : "page-image-11"} />
      <img src={Image11_11} alt="Page 11" className={Zulu ? "page-image-big-mobile" : "page-image-11-11"} />
