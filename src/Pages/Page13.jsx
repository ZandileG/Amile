...
function Page13(){
  ...
  return(
    <section className="page">
      <img src={Image13} alt="Page 13" className={Zulu ? "page-image-big-desktop-13" : "page-image-13"} />
      <img src={Image13_13} alt="Page 13" className={Zulu ? "page-image-big-mobile-13" : "page-image-13-13"} />
